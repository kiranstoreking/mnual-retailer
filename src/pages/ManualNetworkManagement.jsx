...
const translations = {
  ...
  kn: {
    ...
    nextStepsTitle: "ನೆಟ್‌ವರ್ಕ್ ನಿರ್ವಹಣೆ ಪೂರ್ಣಗೊಂಡಿದೆ!",
    nextStepsDescription: "ನೀವು ಈಗ ವ್ಯಕ್ತಿಗತ ಗ್ರಾಹಕರಿಂದ ವ್ಯಾಪಾರ ಪಾಲುದಾರರವರೆಗೆ ನಿಮ್ಮ ಸಂಪೂರ್ಣ ಗ್ರಾಹಕ ನೆಟ್‌ವರ್ಕ್ ಅನ್ನು ಹೇಗೆ ನಿರ್ವಹಿಸಬೇಕೆಂದು ಸಮಗ್ರ ತಿಳುವಳಿಕೆಯನ್ನು ಹೊಂದಿದ್ದೀರಿ. ಬಲವಾದ ಸಂಬಂಧಗಳನ್ನು ನಿರ್ಮಿಸಲು ಮತ್ತು ಬೆಳವಣಿಗೆಯನ್ನು ಉತ್ತೇಜಿಸಲು ಈ ಸಾಧನಗಳನ್ನು ಬಳಸಿ.",
    nextStepsButton: "ಪೇ ಲೇಟರ್ ನಿರ್ವಹಣೆಗೆ ಮುಂದುವರೆಯಿರಿ",
  },
  te: {
    ...
    nextStepsTitle: "నెట్‌వర్క్ నిర్వహణ పూర్తయింది!",
    nextStepsDescription: "మీరు ఇప్పుడు వ్యక్తిగత వినియోగదారుల నుండి వ్యాపార భాగస్వాముల వరకు మీ మొత్తం కస్టమర్ నెట్‌వర్క్‌ని ఎలా నిర్వహించాలో సమగ్ర అవగాహన కలిగి ఉన్నారు. బలమైన సంబంధాలను నిర్మించడానికి మరియు వృద్ధిని ప్రోత్సహించడానికి ఈ సాధనాలను ఉపయోగించండి.",
    nextStepsButton: "పే లేటర్ నిర్వహణకు కొనసాగండి",
  },
  ta: {
    ...
    nextStepsTitle: "நெட்வொர்க் மேலாண்மை முடிந்தது!",
    nextStepsDescription: "தனிப்பட்ட நுகர்வோரிடமிருந்து வணிக பங்குதாரர்கள் வரை உங்கள் முழு வாடிக்கையாளர் நெட்வொர்க்கை எவ்வாறு நிர்வகிப்பது என்பதைப் பற்றி நீங்கள் இப்போது விரிவான புரிதலைக் கொண்டுள்ளீர்கள். வலுவான உறவுகளை உருவாக்கவும் வளர்ச்சியை ஊக்குவிக்கவும் இந்த கருவிகளைப் பயன்படுத்துங்கள்.",
    nextStepsButton: "பே லேட்டர் மேலாண்மைக்கு தொடரவும்",
  },
  hi: {
    ...
    nextStepsTitle: "नेटवर्क प्रबंधन पूरा हुआ!",
    nextStepsDescription: "अब आपके पास व्यक्तिगत उपभोक्ताओं से लेकर व्यावसायिक भागीदारों तक अपने पूरे ग्राहक नेटवर्क को प्रबंधित करने की व्यापक समझ है। मजबूत संबंध बनाने और विकास को बढ़ावा देने के लिए इन उपकरणों का उपयोग करें।",
    nextStepsButton: "पे लेटर प्रबंधन पर जारी रखें",
  },
  ml: {
    ...
    nextStepsTitle: "നെറ്റ്‌വർക്ക് മാനേജ്മെന്റ് പൂർത്തിയായി!",
    nextStepsDescription: "വ്യക്തിഗത ഉപഭോക്താക്കളിൽ നിന്ന് ബിസിനസ് പങ്കാളികൾ വരെ നിങ്ങളുടെ മുഴുവൻ ഗ്രാഹക നെറ്റ്‌വർക്ക് എങ്ങനെ നിയന്ത്രിക്കണമെന്നതിനെക്കുറിച്ച് നിങ്ങൾക്ക് ഇപ്പോൾ സമഗ്രമായ ധാരണയുണ്ട്. ശക്തമായ ബന്ധങ്ങൾ കെട്ടിപ്പടുക്കാനും വളർച്ചയെ പ്രോത്സാഹിപ്പിക്കാനും ഈ ഉപകരണങ്ങൾ ഉപയോഗിക്കുക.",
    nextStepsButton: "പേ ലേറ്റർ മാനേജ്മെന്റിലേക്ക് തുടരുക",
  }
};
